...
- name: AWS Directory Service API - Disable Radius
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-directory-service/actiondisableradius-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-directory-service/actiondisableradius-get-openapi.md
- name: AWS Directory Service API - Enable Radius
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-directory-service/actionenableradius-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-directory-service/actionenableradius-get-openapi.md
- name: AWS Directory Service API - Update Radius
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-directory-service/actionupdateradius-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-directory-service/actionupdateradius-get-openapi.md
x-common:
- type: x-api-gallery
