...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-server-migration-service/apis.md
...
- name: AWS Server Migration Service API - Disassociate Connector
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-server-migration-service/actiondisassociateconnector-get-openapi.md
- name: AWS Server Migration Service API - Get Connectors
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/connections/master/_listings/aws-server-migration-service/actiongetconnectors-get-openapi.md
x-common:
- type: x-api-gallery
